/*
 * @author Paul Varcholik (Paul.Varcholik@ucf.edu)
 */
#pragma once

#include <string>

namespace SoGlEngine
{
    /*!
     * Used to identify and query a class's type at run-time
     */
    class RTTI
    {
    public:
...
public:                                                                                             \
    ...
    virtual InuEngine::RTTI* QueryInterface(const unsigned int id) const                            \
    {                                                                                               \
